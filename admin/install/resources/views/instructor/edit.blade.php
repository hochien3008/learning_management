                    ...
                    <div class="col-md-12 mt-2">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <label class="form-label">{{ __('Name') }} <span class="text-danger fw-bold">*</span> </label>
                                    ...
                                    <div class="col-md-4">
                                        <label class="form-label">{{ __('Email') }} <span class="text-danger fw-bold">*</span> </label>
                                    ...
                                    <div class="col-md-4">
                                        <label class="form-label">{{ __('Phone') }} <span class="text-danger fw-bold">*</span> </label>
                                        <input type="text" name="phone"
                                            value="{{ old('phone') ?? $instructor->user->phone ? $instructor->user->phone : '01'.rand(100000000, 999999999) }}" class="form-control"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <div class="mt-2">
                                                    <strong>{{ __('Characters') }}: <span id="charCount">0</span>/60</strong>
                                                </div>
                                                @error('title')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="col-md-12">
                                                <label for="aboutInput" class="form-label">{{ __('Instructor About') }}</label>
                                                <textarea name="about" rows="14" class="form-control" id="aboutInput" placeholder="{{ __('Enter about text') }}">{{ old('about') ?? $instructor->about }}</textarea>
                                                @error('about')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-md-6 mt-4">
                                        ...
                                        <label for="uploadSignature" class="additionThumbnail"
                                            ...
                                            <img src="{{ $instructor->signaturePath ?? asset('enrollment/upload.png') }}" id="attribute38preview0"
