                    ...
                    <div class="card mb-5">
                        <div class="card-body">
                            <div class=" d-flex justify-content-end mb-3 align-items-center">
                                <form action="{{ route('instructor.index') }}" method="GET" class="w-25 me-2">
                                ...
                                <div class="d-flex justify-content-end">
                                    <a href="{{ route('instructor.index') }}" class="px-3">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        @forelse ($instructors as $instructor)
                                            <tr>
                                                ...
                                                <td class="tableCustomar">
                                                    ...
                                                    @else
                                                        <span class="badge rounded-pill text-bg-danger">{{ __('No') }}</span>
                                                    @endif
                                                </td>
                                                    ...
                                                    @if ($instructor->trashed())
                                                        <div class="statusItem">
                                                            ...
                                                            <div class="statusText">
                                                                <span class="statusPending">{{ __('Deleted') }}</span>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="statusItem">
                                                    ...
                                                    <div class="action-icon">
                                                        ...
                                                        @else
                                                            <a class="circleIcon" data-bs-toggle="tooltip"
                                                                ...
                                                                href="{{ route('instructor.edit', $instructor->id) }}"><img
                                                            ...
                                                            @if ($instructor->user_id != auth()->user()->id)
                                                                <a class="circleIcon" data-bs-toggle="tooltip"
                                                                    data-bs-placement="top"
                                                                    data-bs-custom-class="custom-tooltip"
                                                                    data-bs-title="{{ __('Suspend Instructor') }}" href="#"
                                                                    onclick="deleteAction('{{ route('instructor.destroy', $instructor->id) }}')"><img
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="8">
                                                    <h5 class="text-danger text-center m-0">{{ __('No Instructor Available') }}</h5>
                                                </td>
                                            </tr>
                                        @endforelse
                                    </tbody>
